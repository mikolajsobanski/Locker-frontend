...
function CategoryNavigation(){
    ...
    return(
            ...
            <nav class="nav-menu-category">
                <ul>
                    <li id="services"><a href="/football">Piłka Nożna</a>
                    <div class="sub-nav">
                ...
                <li id="services"><a href="/basketball">Koszykówka</a>
                    <div class="sub-nav">
                        <div class="sub-nav-col left">
                            <a href="#" class="sub-nav-box" id="box-1">
                                <div class="icon-background" id="icon-1">
                ...
                <li id="services"><a href="#">Siłownia</a>
                    <div class="sub-nav">
                        <div class="sub-nav-col left">
                            <a href="#" class="sub-nav-box" id="box-1">
                                <div class="icon-background" id="icon-1">
